...
export const ROLES: Role[] = [
  ...
  },
  {
    ...
    before: 'Experienced cloud engineer skilled in designing and managing scalable, reliable cloud infrastructure across multiple platforms.',
    after: 'Migrated 60 services to AWS ECS with Terraform-managed infrastructure, cutting monthly cloud spend 28% ($14k) and lifting deployment reliability to 99.95% uptime.',
    keywords: [
      'AWS', 'Azure', 'GCP', 'Terraform', 'Kubernetes', 'CloudFormation',
      'Infrastructure as Code', 'CI/CD', 'Cost optimization', 'Networking (VPC)', 'Docker', 'Monitoring',
    ],
    templates: ['minimal', 'volt', 'prime'],
    faqs: [
      { q: 'Should a cloud engineer resume focus on one provider or several?', a: 'Lead with the provider the posting names and go deep on it. Listing AWS, Azure, and GCP equally can read as shallow — show real depth on your primary platform, then mention others honestly.' },
      { q: 'How do I show cloud impact on a resume?', a: 'Cost saved, uptime improved, scale handled, or deployment speed gained. "Cut cloud spend 28%" or "reached 99.95% uptime" beats "managed cloud infrastructure" by a wide margin.' },
      { q: 'Are cloud certifications worth listing?', a: 'Yes — AWS Solutions Architect, Azure Administrator, or GCP Professional are filtered for in many ATS and signal verified skill. List them near the top with the level achieved.' },
    ],
  },
  {
    slug: 'network-engineer',
    title: 'Network Engineer',
    metaTitle: 'Network Engineer Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A network engineer resume that mirrors the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your network infrastructure work — preview free.',
    intro: 'A network engineer resume should show the networks you designed and maintained, the scale and uptime you delivered, and the certifications behind your name — not that you are technically proficient. ATS filters hard on networking terminology and vendor names, so mirroring the posting matters.',
    whatMatters: [
    ...
    before: 'Technically proficient network engineer with experience designing and maintaining reliable enterprise network infrastructure.',
    after: 'Redesigned a 12-site WAN to SD-WAN (Cisco Meraki), cutting circuit costs 35% and reducing branch outages from ~6/month to under 1 while supporting 1,400 users.',
    keywords: [
      'Cisco', 'Routing & switching', 'BGP', 'OSPF', 'Firewalls', 'VPN',
      'SD-WAN', 'TCP/IP', 'Network security', 'CCNA / CCNP', 'Load balancing', 'Network monitoring',
    ],
    templates: ['minimal', 'prime', 'volt'],
    faqs: [
      { q: 'Where do networking certifications go on a resume?', a: 'Near the top — CCNA, CCNP, or vendor certs are filtered for in ATS and signal verified skill. Include the vendor and keep them current.' },
      { q: 'How do I quantify network engineering experience?', a: 'Number of sites, users, or devices supported, uptime percentage, and incident or cost reductions. "Cut branch outages from 6/month to under 1" tells a clear story.' },
      { q: 'Should I list specific vendor equipment?', a: 'Yes, the ones the posting names and you genuinely know — Cisco, Juniper, Palo Alto, Meraki. ATS weights vendor names heavily for networking roles.' },
    ],
  },
  {
    slug: 'mobile-developer',
    title: 'Mobile Developer',
    metaTitle: 'Mobile Developer Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A mobile developer resume that matches the job posting and clears ATS. Paste the role, get keyword-aligned bullets around your iOS or Android work — preview free.',
    intro: 'A mobile developer resume needs to show the apps you shipped, their reach, and the platform and language you built them in — not that you are passionate about mobile. Recruiters and ATS scan for the exact platform and frameworks in the posting, so naming iOS/Swift or Android/Kotlin precisely matters.',
    whatMatters: [
      'Shipped apps — what you built, downloads or active users, and your role on it.',
      'Platform specificity — iOS/Swift, Android/Kotlin, or cross-platform (React Native, Flutter).',
      'Quality signals — crash rate, app-store rating, or performance you improved.',
      'Stack match — the platform, language, and frameworks the posting names.',
    ],
    before: 'Passionate mobile developer with experience building high-quality, user-friendly apps for iOS and Android platforms.',
    after: 'Built and shipped an iOS app (Swift, SwiftUI) to 300k+ downloads, cutting crash rate from 1.4% to 0.2% and lifting App Store rating from 3.6 to 4.5 over three releases.',
    keywords: [
      'Swift', 'Kotlin', 'iOS', 'Android', 'React Native', 'Flutter',
      'SwiftUI', 'Jetpack Compose', 'REST API', 'App Store / Play Store', 'Mobile UI', 'Performance optimization',
    ],
    templates: ['minimal', 'aurora', 'volt'],
    faqs: [
      { q: 'Should I specialise in iOS or Android on my resume?', a: 'Match the posting. If the role says iOS, lead with Swift and App Store work; if Android, lead with Kotlin and Play Store. For cross-platform roles, show React Native or Flutter depth — do not split focus against what the job asks for.' },
      { q: 'How do I show mobile app impact on a resume?', a: 'Downloads, active users, crash rate, app-store rating, or load time. "Grew to 300k downloads and a 4.5 rating" beats "built mobile apps" every time.' },
      { q: 'Should I link to apps I have shipped?', a: 'Yes — link App Store or Play Store pages for apps you built. A shipped, rated app is the strongest proof a mobile developer can offer.' },
    ],
  },
  {
    slug: 'data-engineer',
    title: 'Data Engineer',
    metaTitle: 'Data Engineer Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A data engineer resume that mirrors the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your pipelines and data infrastructure — preview free.',
    intro: 'A data engineer resume needs to show the pipelines you built, the scale of data they moved, and the reliability you delivered — not that you work with big data. Recruiters and ATS scan for the exact stack in the posting, so naming the right warehouse, orchestration, and processing tools matters.',
    whatMatters: [
    ...
    before: 'Skilled data engineer with experience building scalable data pipelines and infrastructure to support analytics and machine learning.',
    after: 'Built an Airflow + dbt pipeline ingesting 2TB/day into Snowflake, cutting report freshness from 24h to 2h and reducing warehouse costs 30% through partitioning and query tuning.',
    keywords: [
      'Python', 'SQL', 'Apache Spark', 'Airflow', 'dbt', 'Snowflake',
      'Kafka', 'ETL / ELT', 'Data warehousing', 'BigQuery', 'Data modeling', 'CI/CD',
    ],
    templates: ['minimal', 'prime', 'nordic'],
    faqs: [
      { q: 'How is a data engineer resume different from a data scientist resume?', a: 'A data engineer resume emphasises pipelines, infrastructure, and data reliability; a data scientist resume emphasises modelling and analysis. Mirror the posting’s language — ATS keyword matching is unforgiving about the difference.' },
      { q: 'How do I quantify data engineering impact?', a: 'Data volume moved, pipeline freshness or SLA, query speed, and warehouse cost. "Cut report freshness from 24h to 2h" communicates impact in one line.' },
      { q: 'Should I list every data tool I have used?', a: 'List the ones the posting names and you can speak to. A focused, relevant stack reads as depth; an exhaustive tool dump dilutes your ATS match and reads as padding.' },
    ],
  },
  {
    slug: 'product-designer',
    title: 'Product Designer',
    metaTitle: 'Product Designer Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A product designer resume that matches the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your design and product impact — preview free.',
    intro: 'A product designer resume needs to connect design work to product outcomes — what you shipped, who you designed for, and what moved as a result. Hiring managers look past tool lists for evidence that you own problems end-to-end, from research to shipped UI, and ATS filters on the exact tools and methods in the posting.',
    whatMatters: [
    ...
    before: 'Creative product designer passionate about solving user problems and crafting beautiful, intuitive product experiences.',
    after: 'Owned the checkout redesign end-to-end — research, prototyping, and engineering handoff — lifting completed purchases 14% and cutting drop-off at the payment step by a third.',
    keywords: [
      'Figma', 'User research', 'Prototyping', 'Design systems', 'Interaction design', 'Usability testing',
      'Product thinking', 'A/B testing', 'Wireframing', 'Cross-functional collaboration', 'Accessibility', 'Information architecture',
    ],
    templates: ['aurora', 'atelier', 'minimal'],
    faqs: [
      { q: 'What is the difference between a product designer and UX designer resume?', a: 'Product designer resumes lean harder into product outcomes and business metrics; UX designer resumes lean into research and interaction craft. The overlap is large — mirror whichever the posting emphasises.' },
      { q: 'Should I include a portfolio link?', a: 'Always — it matters more than the resume itself. One curated link with case studies that show process and measured outcomes, not just final screens.' },
      { q: 'How do I show product impact as a designer?', a: 'Tie design work to a product metric: conversion, retention, activation, or support tickets reduced. Resumetion turns your notes into outcome-led bullets without inventing numbers.' },
    ],
  },
  {
    slug: 'scrum-master',
    title: 'Scrum Master',
    metaTitle: 'Scrum Master Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A scrum master resume that mirrors the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your agile delivery work — preview free.',
    intro: 'A scrum master resume needs to show the teams you served, the delivery you improved, and the certifications you hold — not that you are a servant leader. Hiring managers scan for agile frameworks, team scope, and concrete improvements, and ATS filters on agile terminology.',
    whatMatters: [
      'Certifications — CSM, PSM, or SAFe, listed up front.',
      'Team scope — number and type of teams, and the products they delivered.',
      'Delivery improvement — velocity, predictability, or cycle-time gains you facilitated.',
      'Framework match — Scrum, Kanban, SAFe, or whatever the posting uses.',
    ],
    before: 'Servant-leader scrum master passionate about agile principles and helping teams deliver value continuously.',
    after: 'Coached two product teams (16 people) through a Scrum adoption that lifted sprint predictability from 60% to 90% and cut average story cycle time from 9 to 4 days.',
    keywords: [
      'Scrum', 'Agile', 'Kanban', 'SAFe', 'Sprint planning', 'Jira',
      'Velocity', 'Retrospectives', 'CSM / PSM', 'Backlog management', 'Stakeholder facilitation', 'Continuous improvement',
    ],
    templates: ['minimal', 'prime', 'nordic'],
    faqs: [
      { q: 'Is a scrum certification required on a resume?', a: 'Often, yes — CSM or PSM is filtered for in many ATS and expected by hiring managers. List it near the top with the issuing body. If you do not have it yet, lean hard into concrete delivery improvements.' },
      { q: 'How do I quantify scrum master impact?', a: 'Sprint predictability, velocity stability, cycle time, and team health. "Lifted predictability from 60% to 90%" communicates real facilitation impact, not just attendance at ceremonies.' },
      { q: 'What is the difference between a scrum master and project manager resume?', a: 'A scrum master resume emphasises team facilitation, agile coaching, and impediment removal; a project manager resume emphasises scope, budget, and delivery ownership. Mirror the posting’s framing.' },
    ],
  },
  {
    slug: 'digital-marketing-specialist',
    title: 'Digital Marketing Specialist',
    metaTitle: 'Digital Marketing Specialist Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A digital marketing specialist resume that matches the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your campaign results — preview free.',
    intro: 'A digital marketing specialist resume needs to show the channels you ran, the metrics you moved, and the tools you used — not that you are a creative, data-driven marketer. Recruiters scan for channel-specific results, and ATS filters on the exact platforms in the posting.',
    whatMatters: [
    ...
    before: 'Creative, data-driven digital marketing specialist with experience running multi-channel campaigns that drive engagement and growth.',
    after: 'Ran SEO and paid search for an e-commerce brand, growing organic traffic 60% in six months and cutting paid CPA 22% while managing a $25k/month ad budget.',
    keywords: [
      'SEO', 'Google Ads', 'Google Analytics', 'Meta Ads', 'Email marketing', 'Content marketing',
      'Conversion rate optimization', 'Social media', 'PPC', 'A/B testing', 'HubSpot', 'Marketing automation',
    ],
    templates: ['minimal', 'aurora', 'prime'],
    faqs: [
      { q: 'How do I show digital marketing results on a resume?', a: 'Name the channel, the metric, and the change: organic traffic growth, CPA reduction, conversion rate, or email open and click rates. Resumetion builds outcome-led bullets from your notes without inventing numbers.' },
      { q: 'Should a digital marketer be a generalist or specialist on a resume?', a: 'Match the posting. A specialist role (SEO, paid, email) wants depth in one channel; a generalist role wants breadth across several. Lead with what the job weights most.' },
      { q: 'What tools should a digital marketing resume list?', a: 'The platforms the posting names — Google Ads, GA4, Meta Ads Manager, HubSpot, SEMrush — plus any you genuinely use. ATS weights these tool names heavily for marketing roles.' },
    ],
  },
  {
    slug: 'account-manager',
    title: 'Account Manager',
    metaTitle: 'Account Manager Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'An account manager resume that mirrors the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your retention and growth — preview free.',
    intro: 'An account manager resume needs to show the book you managed, how well you retained and grew it, and the relationships behind the numbers — not that you are relationship-focused. Recruiters scan for portfolio size, retention, and growth, and ATS filters on the terminology in the posting.',
    whatMatters: [
    ...
    before: 'Relationship-focused account manager dedicated to client success and building long-term partnerships that drive growth.',
    after: 'Managed a $3.2M book of 40 mid-market accounts, holding 94% gross retention and growing the portfolio 18% through expansion deals and quarterly business reviews.',
    keywords: [
      'Account management', 'Client retention', 'Upselling', 'Salesforce', 'Renewals', 'Relationship building',
      'QBRs', 'Customer success', 'Revenue growth', 'Churn reduction', 'B2B', 'Stakeholder management',
    ],
    templates: ['minimal', 'prime', 'aurora'],
    faqs: [
      { q: 'How do I quantify account management experience?', a: 'Book size (accounts and revenue), gross and net retention, churn, and expansion revenue. "Held 94% retention on a $3.2M book" tells a story; "managed client relationships" does not.' },
      { q: 'What is the difference between an account manager and account executive resume?', a: 'An account manager resume emphasises retention, growth, and relationship depth on existing accounts; an account executive resume emphasises new-business closing and quota. Mirror the posting exactly.' },
      { q: 'Should I name the clients I managed?', a: 'Name recognisable logos if it helps and confidentiality allows; otherwise describe them by industry and size. The retention and growth numbers matter more than the names.' },
    ],
  },
  {
    slug: 'customer-success-manager',
    title: 'Customer Success Manager',
    metaTitle: 'Customer Success Manager Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A customer success manager resume that matches the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your retention and adoption work — preview free.',
    intro: 'A customer success manager resume needs to show the accounts you owned, the retention and adoption you drove, and the playbooks you ran — not that you are customer-obsessed. Recruiters scan for portfolio scale and CS metrics, and ATS filters on the exact terminology in the posting.',
    whatMatters: [
    ...
    before: 'Customer-obsessed success manager committed to driving adoption, retention, and long-term value for every account.',
    after: 'Owned a 50-account, $4M ARR portfolio, lifting net revenue retention from 98% to 112% through a redesigned onboarding and a quarterly health-check cadence that flagged churn risk 60 days early.',
    keywords: [
      'Customer success', 'Net revenue retention', 'Churn reduction', 'Onboarding', 'Product adoption', 'Gainsight',
      'Renewals', 'Upsell / expansion', 'Account health', 'QBRs', 'SaaS', 'Stakeholder management',
    ],
    templates: ['minimal', 'prime', 'aurora'],
    faqs: [
      { q: 'How do I quantify customer success impact?', a: 'Net revenue retention, gross retention, churn, ARR managed, and adoption metrics. "Lifted NRR from 98% to 112%" is the single most powerful line a CSM can put on a resume.' },
      { q: 'What is the difference between a CSM and account manager resume?', a: 'A CSM resume leans into adoption, onboarding, and product value realisation; an account manager resume leans into commercial growth and relationship management. The line blurs — mirror the posting’s emphasis.' },
      { q: 'Should a customer success resume mention specific tools?', a: 'Yes — Gainsight, Totango, ChurnZero, or the CRM the posting names. ATS weights these for CS roles, and they signal you have run a real CS motion.' },
    ],
  },
  {
    slug: 'social-media-manager',
    title: 'Social Media Manager',
    metaTitle: 'Social Media Manager Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A social media manager resume that mirrors the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your growth and engagement — preview free.',
    intro: 'A social media manager resume needs to show the platforms you grew, the engagement and follower numbers behind your work, and the campaigns you ran — not that you are creative and online. Recruiters scan for platform-specific results, and ATS filters on the tools and channels in the posting.',
    whatMatters: [
      'Growth numbers — follower, reach, or engagement-rate increases you drove, with figures.',
      'Platform specificity — Instagram, TikTok, LinkedIn, or X, named with real results.',
      'Content and campaigns — what you produced, the cadence, and any campaign that broke out.',
      'Tools — scheduling, analytics, and design tools the posting names.',
    ],
    before: 'Creative social media manager with a passion for storytelling and building engaged online communities across platforms.',
    after: 'Grew a brand’s Instagram from 12k to 78k followers in a year, lifting average engagement rate to 5.2%, and ran a TikTok campaign that drove 1.4M views and 9k site visits.',
    keywords: [
      'Social media strategy', 'Instagram', 'TikTok', 'LinkedIn', 'Content creation', 'Community management',
      'Engagement rate', 'Analytics', 'Paid social', 'Content calendar', 'Influencer marketing', 'Copywriting',
    ],
    templates: ['aurora', 'atelier', 'minimal'],
    faqs: [
      { q: 'How do I show social media results on a resume?', a: 'Follower growth, engagement rate, reach, and the business outcomes that followed (site visits, leads, sales). "Grew Instagram from 12k to 78k at 5.2% engagement" beats "managed social channels".' },
      { q: 'Should I link to accounts I have managed?', a: 'Yes, where appropriate — a link to a brand account you grew is strong proof. If accounts are confidential, describe the growth with numbers instead.' },
      { q: 'Which platforms should I emphasise?', a: 'The ones the posting names. A role hiring for TikTok wants TikTok-specific wins; a B2B role wants LinkedIn. Match the job, do not just list every platform you have touched.' },
    ],
  },
  {
    slug: 'bookkeeper',
    title: 'Bookkeeper',
    metaTitle: 'Bookkeeper Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A bookkeeper resume that matches the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your bookkeeping work — preview free.',
    intro: 'A bookkeeper resume needs to show the books you kept, the software you ran them in, and the accuracy you delivered — not that you are organised and trustworthy. Hiring managers scan for the specific accounting tasks and tools in the posting, and ATS filters on the terminology.',
    whatMatters: [
      'Scope — the businesses or accounts you kept books for, and their size or transaction volume.',
      'Core tasks — AP/AR, reconciliations, payroll, and reporting you owned.',
      'Software — QuickBooks, Xero, or the system the posting names.',
      'Accuracy and timeliness — clean reconciliations, on-time reporting, or error reductions.',
    ],
    before: 'Organised and trustworthy bookkeeper with strong attention to detail and experience maintaining accurate financial records.',
    after: 'Kept full-cycle books for 8 small-business clients in QuickBooks Online, reconciling 1,200+ monthly transactions and delivering month-end reports within 3 business days, error-free across two tax years.',
    keywords: [
      'QuickBooks', 'Xero', 'Accounts payable', 'Accounts receivable', 'Bank reconciliation', 'Payroll',
      'General ledger', 'Financial reporting', 'Invoicing', 'Month-end close', 'Excel', 'Data entry',
    ],
    templates: ['minimal', 'prime', 'nordic'],
    faqs: [
      { q: 'What software should a bookkeeper resume list?', a: 'The ones the posting names plus the major systems you know — QuickBooks (Online and Desktop), Xero, or Sage. ATS weights these heavily, and most bookkeeping roles filter for a specific platform.' },
      { q: 'How do I quantify bookkeeping experience?', a: 'Number of clients or entities, transaction volume, reporting turnaround, and accuracy. "Reconciled 1,200+ monthly transactions, error-free across two tax years" beats "maintained accurate records".' },
      { q: 'What is the difference between a bookkeeper and accountant resume?', a: 'A bookkeeper resume emphasises day-to-day record-keeping, reconciliations, and AP/AR; an accountant resume emphasises financial statements, GAAP, and analysis. Mirror the posting so the ATS match is exact.' },
    ],
  },
  {
    slug: 'executive-assistant',
    title: 'Executive Assistant',
    metaTitle: 'Executive Assistant Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'An executive assistant resume that mirrors the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your executive support work — preview free.',
    intro: 'An executive assistant resume needs to show who you supported, the complexity you managed, and where you saved time or unblocked decisions — not that you are organised and discreet. Hiring managers scan for the seniority of the executives you supported and the scope of what you owned.',
    whatMatters: [
    ...
    before: 'Organised and discreet executive assistant with excellent communication skills and experience supporting senior leadership.',
    after: 'Supported a CEO and two VPs, managing complex global calendars and board-meeting prep, and built a travel-and-expense workflow that saved roughly 5 hours of leadership time each week.',
    keywords: [
      'Calendar management', 'Travel coordination', 'Executive support', 'Board preparation', 'Expense management', 'Microsoft Office',
      'Google Workspace', 'Confidentiality', 'Meeting coordination', 'Project coordination', 'Stakeholder communication', 'Event planning',
    ],
    templates: ['minimal', 'prime', 'nordic'],
    faqs: [
      { q: 'How is an executive assistant resume different from an administrative assistant resume?', a: 'An executive assistant resume emphasises C-suite support, confidentiality, board prep, and judgment on the executive’s behalf; an administrative assistant resume emphasises broader office and team support. Mirror the seniority the posting expects.' },
      { q: 'How do I quantify executive assistant experience?', a: 'The level and number of executives supported, the complexity managed (global travel, board work), and time or cost saved. "Saved ~5 hours of leadership time weekly" shows real impact.' },
      { q: 'Should an executive assistant resume mention confidentiality?', a: 'Show it through the work — board materials, sensitive communications, personnel matters — rather than just claiming "discreet". Demonstrated trust at a senior level is the point.' },
    ],
  },
  {
    slug: 'recruiter',
    title: 'Recruiter',
    metaTitle: 'Recruiter Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A recruiter resume that matches the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your hiring results — preview free.',
    intro: 'A recruiter resume needs to show the roles you filled, your speed and quality of hire, and the pipelines you built — not that you are a great communicator. Hiring managers scan for hiring volume, time-to-fill, and the type of roles you recruited for, and ATS filters on recruiting terminology.',
    whatMatters: [
    ...
    before: 'Results-driven recruiter with strong communication skills and a passion for connecting great talent with great opportunities.',
    after: 'Filled 45 technical roles in a year as the sole in-house recruiter, cutting average time-to-fill from 48 to 29 days and holding a 91% offer-acceptance rate through structured sourcing and candidate experience.',
    keywords: [
      'Full-cycle recruiting', 'Sourcing', 'LinkedIn Recruiter', 'ATS (Greenhouse / Lever)', 'Time-to-fill', 'Candidate experience',
      'Boolean search', 'Interviewing', 'Talent pipeline', 'Offer negotiation', 'Technical recruiting', 'Stakeholder management',
    ],
    templates: ['minimal', 'prime', 'aurora'],
    faqs: [
      { q: 'How do I quantify recruiting experience on a resume?', a: 'Number of hires, time-to-fill, offer-acceptance rate, and quality or retention of hires. "Filled 45 technical roles, cutting time-to-fill from 48 to 29 days" tells a complete story.' },
      { q: 'What is the difference between an agency and in-house recruiter resume?', a: 'Agency resumes emphasise req volume, placements, and revenue; in-house resumes emphasise quality of hire, candidate experience, and stakeholder partnership. Mirror the model the posting is hiring for.' },
      { q: 'Should a recruiter resume mention specific ATS tools?', a: 'Yes — Greenhouse, Lever, Workday, or LinkedIn Recruiter. ATS keyword matching favours them, and they signal you have run a real recruiting process at scale.' },
    ],
  },
  {
    slug: 'pharmacist',
    title: 'Pharmacist',
    metaTitle: 'Pharmacist Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A pharmacist resume that matches the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your clinical and dispensing work — preview free.',
    intro: 'A pharmacist resume needs to show your licensure, clinical scope, and setting clearly enough for a busy pharmacy manager and a hospital ATS — not vague claims of being patient-focused. Concrete dispensing volume, clinical services, and the systems you used matter more than adjectives.',
    whatMatters: [
      'Licensure — state pharmacist license, plus immunization or specialty certifications, up front.',
      'Setting and scope — retail, hospital, or clinical, with dispensing volume and patient load.',
      'Clinical services — MTM, immunizations, counseling, or rounds you performed.',
      'Systems and safety — pharmacy software and error-reduction or compliance results.',
    ],
    before: 'Patient-focused pharmacist committed to safe, accurate medication dispensing and excellent patient care.',
    after: 'Verified 350+ prescriptions per shift in a high-volume retail pharmacy, ran an immunization program that delivered 1,200+ vaccinations in a season, and cut dispensing errors 40% through a double-check workflow.',
    keywords: [
      'Pharmacist license', 'Medication therapy management', 'Immunizations', 'Prescription verification', 'Patient counseling', 'Drug interactions',
      'Pharmacy software', 'Compounding', 'Inventory management', 'HIPAA', 'Clinical pharmacy', 'BLS',
    ],
    templates: ['minimal', 'prime', 'atelier'],
    faqs: [
      { q: 'Where do licenses go on a pharmacist resume?', a: 'Near the top, in their own clearly-labeled section — state pharmacist license, immunization certification, and any specialty credentials. Pharmacy managers and ATS look for them first.' },
      { q: 'How do I quantify pharmacist experience?', a: 'Prescription volume per shift, immunizations delivered, patient counseling load, and any safety or error-reduction results. "Verified 350+ prescriptions per shift" situates your experience instantly.' },
      { q: 'How do I tailor a pharmacist resume for retail vs hospital roles?', a: 'Retail emphasises dispensing volume, immunizations, and patient counseling; hospital emphasises clinical rounds, MTM, and interdisciplinary work. Paste the posting and the wording reorders to surface the most relevant experience.' },
    ],
  },
  {
    slug: 'nurse-practitioner',
    title: 'Nurse Practitioner',
    metaTitle: 'Nurse Practitioner Resume — ATS-Ready & Tailored | Resumetion',
    metaDescription: 'A nurse practitioner resume that mirrors the job posting and passes ATS. Paste the role, get keyword-aligned bullets around your advanced practice work — preview free.',
    intro: 'A nurse practitioner resume needs to show your certification, specialty, and scope of practice clearly — for both a hiring physician and a hospital ATS. Concrete patient population, clinical procedures, and the systems you charted in beat vague claims of being a dedicated provider.',
    whatMatters: [
    ...
    before: 'Dedicated nurse practitioner committed to providing compassionate, high-quality care to patients across the lifespan.',
    after: 'Managed a panel of 1,500 primary-care patients as an FNP, independently diagnosing and treating acute and chronic conditions, charting in Epic, and improving the clinic’s diabetes A1c control rate from 58% to 71%.',
    keywords: [
      'NP license', 'Board certification (FNP/AGNP)', 'Patient assessment', 'Diagnosis & treatment', 'Prescribing', 'Epic / EHR',
      'Chronic disease management', 'Primary care', 'Clinical procedures', 'Patient education', 'DEA', 'HIPAA',
    ],
    templates: ['minimal', 'prime', 'atelier'],
    faqs: [
      { q: 'Where do certifications go on a nurse practitioner resume?', a: 'Near the top, in their own section — NP license, board certification (FNP, AGNP, PMHNP), and DEA number where appropriate. Hiring physicians and ATS look for them immediately.' },
      { q: 'How do I quantify nurse practitioner experience?', a: 'Panel size, patient population, procedures performed, and quality outcomes. "Managed a panel of 1,500 and improved A1c control from 58% to 71%" communicates scope and impact in one line.' },
      { q: 'How is an NP resume different from an RN resume?', a: 'An NP resume emphasises advanced practice — diagnosis, treatment, and prescribing — and board certification; an RN resume emphasises bedside care and unit experience. Mirror the advanced-practice scope the posting expects.' },
    ],
  },
]
...
export const CATEGORIES: { name: string; slugs: string[] }[] = [
  { name: 'Engineering & IT', slugs: ['software-engineer', 'frontend-developer', 'backend-developer', 'full-stack-developer', 'mobile-developer', 'devops-engineer', 'cloud-engineer', 'network-engineer', 'qa-engineer', 'cybersecurity-analyst'] },
  { name: 'Data', slugs: ['data-analyst', 'data-scientist', 'data-engineer', 'business-analyst'] },
  { name: 'Design', slugs: ['ux-designer', 'product-designer', 'graphic-designer'] },
  { name: 'Product & Project', slugs: ['product-manager', 'project-manager', 'scrum-master'] },
  { name: 'Marketing & Sales', slugs: ['marketing-manager', 'digital-marketing-specialist', 'social-media-manager', 'sales-representative', 'account-manager', 'customer-success-manager'] },
  { name: 'Finance & Accounting', slugs: ['accountant', 'financial-analyst', 'bookkeeper'] },
  { name: 'Operations & Admin', slugs: ['operations-manager', 'customer-service-representative', 'administrative-assistant', 'executive-assistant', 'human-resources-manager', 'recruiter'] },
  { name: 'Healthcare', slugs: ['registered-nurse', 'nurse-practitioner', 'medical-assistant', 'pharmacist'] },
